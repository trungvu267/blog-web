...
const CreateTag = () => {
  ...
  const { mutation, handleCreateTag } = useCreateTag();
  ...
  return (
    <>
      <SuccessModal isSuccess={mutation.isSuccess} />
      <div className="flex justify-center items-center h-full">
        <div>
          ...
          >
            ...
            <Button className={"bg-primary"} loading={mutation.isLoading}>
  ...
  return (
    <Modal open={visible} onClickBackdrop={() => setVisible(false)}>
      <Modal.Header className="font-bold">
        Tạo danh mục bài viết mới thành công
      </Modal.Header>
    </Modal>
  );
};
